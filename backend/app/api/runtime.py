...
def process_document_task(job_id: str, llm: LlmRuntimeAdapter, parser_service: DocumentParserAdapter, job_repo: JobRepository):
...
async def async_process_document_task(job_id: str, llm: LlmRuntimeAdapter, parser_service: DocumentParserAdapter, job_repo: JobRepository):
...
async def submit_document(
    ...
    doc_parser_service: DocumentParserAdapter = Depends(document_parser_dependency)
):
    """
