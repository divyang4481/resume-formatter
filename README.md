...
2. Deploy the stack using the following command (replace `<YourSecurePassword>` with a strong password for your RDS database. Ensure it does not contain `@`, `/`, `"`, or spaces):
